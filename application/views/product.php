...
?>
    <nav class="bread-crumbs-container product__bread-crumbs">
        <ul class="bread-crumbs">
            ...
            <li class="bread-crumb">
                <a class="bread-crumb__link" href="catalog.php?id=<?= $productInfo['cat_id'] ?>"><?= $productInfo['category'] ?></a>
            </li>
    ...
    <section class="product">
        ...
        <img class="product__image" src="assets/img/products/<?= $productInfo['image'] ?>" alt="Упс! Здесь было фото сигареты, но теперь его нет :(">
